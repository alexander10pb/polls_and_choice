...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        # print(time)
        old_question = Question(question_text="Quien es el mejor Course Director de Platzi?",pub_date=time)
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        # print(time)
        recent_question = Question(question_text="Quien es el mejor Course Director de Platzi?",pub_date=time)
...
class QuestionIndexViewsTest(TestCase):
    ...
    def test_two_future_questions(self):
        """
        The questions with the pub_date in the future aren't not displayed on the index page
        """
